...
const Resignations = (): React.ReactElement => {
  ...
  const handleUpdate = async () => {
    ...
    dispatch(updateResignation({ condition: { ...edit, ...data } }))
  }
    ...
    return searchDate[0]
      ? filterByDate(
          filterArray(
            ...
            ['nombres', 'id_departamento', 'apellidos']
      ...
      : filterArray(
          dataResignation,
          [search, searchDepartamento, searchCargo],
          ['nombres', 'apellidos', 'id_departamento']
        )?.filter((item) => item.estado === stateFilter)
  }, [
    search,
    stateFilter,
        ...
        <CustomRow justify={'end'}>
          <CustomCol xs={24}>
            <CustomForm form={form}>
              <CustomRow>
                <CustomDivider>
                  <CustomTitle>Solicitudes de Renuncia</CustomTitle>
                </CustomDivider>
                ...
                <CustomCol xs={24} md={12}>
                  <CustomRow justify={'end'} gutter={[10, 0]}>
                    ...
                    <CustomCol xs={4} md={2} lg={3} xl={2}>
                      <CustomTooltip title={'Nueva Solicitud de Renuncia'}>
                        <CustomButton
                          icon={<PlusOutlined />}
                          shape={'circle'}
                          size={'middle'}
